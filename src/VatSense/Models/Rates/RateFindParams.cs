...
/// </summary>
public record class RateFindParams : ParamsBase
{
    /// <summary>
    ...
    public RateFindParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RateFindParams(RateFindParams rateFindParams)
        : base(rateFindParams) { }
...
#pragma warning restore CS8618
    ...
    public static RateFindParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(RateFindParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/rates/rate")
        {
