...
public class RateDetailsParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new RateDetailsParams
        {
            CountryCode = "GB",
            Eu = true,
    ...
    {
        RateDetailsParams parameters = new()
        {
            CountryCode = "GB",
            Eu = true,
            IPAddress = "86.27.166.97",
        ...
        Assert.Equal(
            new Uri(
                "https://api.vatsense.com/1.0/rates/tax_rate?country_code=GB&eu=true&ip_address=86.27.166.97&period=2019-12-27T18%3a11%3a19.117%2b00%3a00&province_code=ON&type=ebooks"
            ),
            url
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        RateDetailsParams copied = new(parameters);
