...
/// </summary>
public record class ItemAddParams : ParamsBase
{
    ...
    public ItemAddParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ItemAddParams(ItemAddParams itemAddParams)
        : base(itemAddParams)
    {
        this.InvoiceID = itemAddParams.InvoiceID;

        this._rawBodyData = new(itemAddParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ItemAddParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string invoiceID
    ...
    public virtual bool Equals(ItemAddParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/invoice/{0}/item", this.InvoiceID)
        )
        {
