...
public class InvoiceResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Invoice::InvoiceResponse
        {
            Code = 200,
            Data = new()
            {
        ...
        Invoice::InvoiceInvoice expectedData = new()
        {
            ID = "in5aeae457cda2a",
            Business = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Invoice::InvoiceResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Invoice::InvoiceResponse copied = new(model);
