...
public class RateListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new RateListParams
        {
            CountryCode = "GB",
            Eu = true,
    ...
    public void Url_Works()
    {
        ...
        Assert.Equal(
            new Uri(
                "https://api.vatsense.com/1.0/rates?country_code=GB&eu=true&ip_address=86.27.166.97&period=2019-12-27T18%3a11%3a19.117%2b00%3a00"
            ),
            url
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        RateListParams copied = new(parameters);
